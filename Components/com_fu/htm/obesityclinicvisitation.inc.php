<div class="row">
    <?php $pageTitle = "Obesity Clinic Visit" ?>
    <?= IHTML::BreadCrump("FU", $pageTitle) ?>
    <?= $this->StartPanel($pageTitle); ?>
    <form class="form-horizontal" name='fu_form1' id='fu_form1' action="<?php echo $_SERVER["PHP_SELF"] . "?com_fu=1&obesityclinicvisitation=1&func=save" ?>" method='POST'>
        ...
        <div class="row">
            ...
            <div id="editor" class="editor-wrapper"><?= $form["obesityclivisit"] ?></div>

            <textarea name="obesityclivisit" id="descr" style="display: none;"><?= $form["obesityclivisit"] ?></textarea>
...
<script src="js/htmleditor.js" type="text/javascript"></script>